...
function init()
{
	...
	let links = document.getElementsByClassName( "homepage" );
...
{
	let versionElems = document.getElementsByClassName( className );
...
{
	const indexArray = document.getElementsByClassName("index");
...
function setBuscador()
{
	...
	buscador.addEventListener( "keypress", function(e) {
		...
		if ( key == 13 )
		{
			const item = buscador.value.trim();
			
			const candidatos = document.querySelectorAll("td > a, .operator");
